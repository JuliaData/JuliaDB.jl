...
Multiple processes may not be benificial for datasets with less than a few tens of millions of rows. Communication costs are eliminated on a single process, but of course you will be using a single CPU.
